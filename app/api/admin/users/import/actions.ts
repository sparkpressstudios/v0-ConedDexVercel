...
// Define the expected CSV row structure with more comprehensive validation
const UserRowSchema = z.object({
  ...
  preferences: z.string().max(1000, "Preferences must be 1000 characters or less").optional().nullable(),
