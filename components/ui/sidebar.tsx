...
const Sidebar = React.forwardRef<HTMLDivElement, SidebarProps>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("flex h-full w-64 flex-col bg-sidebar text-sidebar-foreground", className)} {...props} />
))
...
const SidebarFooter = React.forwardRef<HTMLDivElement, SidebarFooterProps>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("border-t border-sidebar-border", className)} {...props} />
))
...
const SidebarSeparator = React.forwardRef<HTMLDivElement, SidebarSeparatorProps>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("my-1 h-px bg-sidebar-border", className)} {...props} />
))
...
// Fixed: Properly handle ref forwarding with polymorphic components
...
function SidebarProvider({ children, ...props }: SidebarProviderProps) {
  return (
